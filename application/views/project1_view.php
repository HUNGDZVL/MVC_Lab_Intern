...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../assets/lab1/assets/img/tree.avif">
    ...
    <link rel="stylesheet" href="../assets/lab1/assets/css/main.css" />
...
<body>
            ...
            <div class="row no-gutters">
                <div class="container__sidebar l-1 ls-1">
                    ...
                    <div class="container__sidebar--bot">
                        <div class="sidebar__bot-img">
                            <img src="../assets/lab1/assets/img/avt1.png " alt="avt">
                        </div>
                        <div class="sidebar__bot-img">
                            <img src="../assets/lab1/assets/img/avt3.avif" alt="avt">

                        </div>
                        <div class="sidebar__bot-img">
                            <img src="../assets/lab1/assets/img/avt4.avif" alt="avt">

                        </div>
                        <div class="sidebar__bot-img">
                            <img src="../assets/lab1/assets/img/avt5.avif" alt="avt">
                ...
                <div class="container__content l-8 ls-8 m-9 c-12">
                    ...
                    <a href="" class="item--info" draggable="false">
                      <div class="img" style="background-image: url(../assets/lab1/assets/img/tree.avif);"></div>
                      <div class="textimg">
                        <p>Space Task2</p>
                        <img src="../assets/lab1/assets/img/avt1.png" alt="avt">
                      </div>
                    ...
                    <div class="item__child" >
                      ...
                      <div class="textimg">
                          ...
                          <div class="avtchen" style="display: flex; position: relative;">
                            ...
                            <img src="../assets/lab1/assets/img/child1.avif" alt="avt">
                            <div class=""></div>
                          </div>
                        </div>
                    ...
                    <div class="item__child">
                      ...
                      <div class="textimg">
                          <p>Space Task2</p>
                            ...
                            <img src="../assets/lab1/assets/img/child2.avif" alt="avt">
                        </div>
                    ...
                    <div class="item__child">
                      ...
                      <div class="textimg">
                          <p>Space Task2</p>
                            ...
                            <img src="../assets/lab1/assets/img/child3.avif" alt="avt">
                        </div>
                    ...
                    <div class="item__child">
                      ...
                      <div class="textimg">
                        ...
                        <p class="text--item">Type Of Paper In Catalog</p>
                                ...
                                <!-- <div class="content__item--info" draggable="false">
                    <a href="" class="item--info" draggable="false">
                      <div class="img" style="background-image: url(../assets/lab1/assets/img/buiding.avif);"></div>
                      <div class="textimg">
                        <p>Space Task2</p>
                        <img src="../assets/lab1/assets/img/child1.avif" alt="avt">
                      </div>
    ...
    <script type="module" src="../assets/lab1/assets/js/main.js"></script>
</body>
